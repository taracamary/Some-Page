# Многостраничный простой сайт, написанный на React. Реализован слайдер с помощью Slick Slider, модальное окно, загрузка дополнительных элементов через кнопку "Загрузить еще"
